...
class SignUpForm(FlaskForm):
    ...
    repeated_password = StringField('repeated_password', validators=[DataRequired(message='Repeated password field is required'), EqualTo('password', message='Passwords must be matching.')])
